...
import azura.helios7.Helios7Core;
import azura.helios7.Hnode7;
import common.collections.buffer.ZintBuffer;
import common.collections.buffer.i.BytesI;

public class Join implements BytesI {

	public Helios7Core helios;
	...
	public Join(Helios7Core helios) {
		this.helios = helios;
	}
	...
	public Join addTo(Hnode7 to) {
		tos.add(to.getId());
		return this;
	}

	public Join addFrom(Hnode7 from) {
