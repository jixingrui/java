...
import azura.helios7.write.OpE;
...
public class Batch {
	...
	public Batch delink(Hnode7 from, Hnode7 to) {
	...
	public Batch delete(Hnode7 node) {
		if (node.getId() == 0)
	...
	public Batch swap(Hnode7 from, Hnode7 to) {
		if (from.getId() == 0 || to.getId() == 0)
